  ...
  zh: {
    ...
    afterword: {
      ...
      paragraphs: [
        ...
        '事實是，我覺得我成功了，然後帶著這個心得還有處理視覺雜音的能力，投入BDSM工具網頁的製作。',
  ...
  en: {
    ...
    afterword: {
      ...
      paragraphs: [
        ...
        'The truth is, I think I succeeded. I carried that lesson—and the ability to clear away visual noise—into making the BDSM tool website.',
