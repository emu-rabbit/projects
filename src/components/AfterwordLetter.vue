        ...
        <div class="letter-model-area">
          <Suspense v-if="modelRequested">
            <WindowNotesMacaronViewer
              ...
              :diagnostic-report-label="copy.modelDiagnosticReportLabel"
              :copy-diagnostic-label="copy.copyModelDiagnosticLabel"
              :diagnostic-copied-label="copy.modelDiagnosticCopiedLabel"
              :diagnostic-copy-failed-label="copy.modelDiagnosticCopyFailedLabel"
              :model-url="modelUrl"
